...
void naming(char name[8],int count_cells)
{
    ...
    counter++;
    char names[][8]= {"sam","bili","bob","ali","jany","warior","jacky","mom","wow","jizz","dany","popy","nazy","iran","danis","venom","batman","halk","boy","farzad","hadi","A.H","armin","sina","killer","nooo","yeees","fish","cat","you","me","they","aahhh","feyj"
                      "freind","BIJ","love","fire","water","ground","wind","book","CEIT","master","origin","dog","moon","sun","tree","~_~","-_-","+_+","=_=","hii","howwm","ice","github","int","float","word","pdf","srt","str","sea","sky","north","witcher","asad"
                       "alex","rick","Mortie","bean","ben","naruto","natso","happy","ken","pete","door","home","footbal","tea","math","OS","wifi","parham","saman","javad","ahmad","apple","banana","momo","esnat","lone","pakhol","oskol","kheytal","yahya","omid","F.mort"};
    static int used[100]= {-1},element=0;
    int oper;
